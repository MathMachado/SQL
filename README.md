...
#### Vídeo 6.4: Right Join
- **Conteúdo:**
  - Comando `RIGHT JOIN`.
  - **Exercícios:** Realização de right joins entre tabelas.

#### Vídeo 6.5: Exemplos Práticos de Joins
- **Conteúdo:**
